...
pub fn main() !void {
    ...
    while (true) {
        ...
        while (game_items.next()) |x| {
            ...
            const red_power: u32 = rgb_cubes[red_index];
            const blue_power: u32 = rgb_cubes[blue_index];
            const green_power: u32 = rgb_cubes[green_index];
            sigma_game_no = sigma_game_no + (red_power * blue_power * green_power);
        }
